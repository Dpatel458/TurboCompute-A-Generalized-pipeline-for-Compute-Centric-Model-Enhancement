"""
MOBILENET SOFT CHANNEL MASKING (NO DATASET / NO FINETUNE)
...
def _build_masked_mobilenet(base_model, masks, alpha):
    tensor_map = {}
    last_tensor = None
...
def prune_mobilenet_mask(model_path, keep_ratio, output_dir, alpha=0.1):
    ...
    masked = _build_masked_mobilenet(base, masks, alpha=alpha)
